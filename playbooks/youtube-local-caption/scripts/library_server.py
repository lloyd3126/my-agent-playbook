...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--library-template", type=Path, default=repo_root / "templates" / "youtube-library")
    parser.add_argument("--player-template", type=Path, default=repo_root / "templates" / "youtube-caption-player")
    return parser
